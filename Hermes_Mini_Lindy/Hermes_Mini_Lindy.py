...
### 8/18/2020 on Yoga - Added ability to add multiple URLs to improbe chances of a find
...
url1 = 'https://www.hermes.com/us/en/search/?s=Mini%20Lindy#||Category'
url2 = 'https://www.hermes.com/us/en/search/?s=mini+lindy'
url3 = 'https://www.hermes.com/us/en/search/?s=lindy%20mini#||Category'
url4 = 'https://www.hermes.com/us/en/search/?s=lindy+mini'

# This give us the ability to add mutiple URLs in the future and loop through each of these.
urls = []
urls.append(url1)
urls.append(url2)
urls.append(url3)
